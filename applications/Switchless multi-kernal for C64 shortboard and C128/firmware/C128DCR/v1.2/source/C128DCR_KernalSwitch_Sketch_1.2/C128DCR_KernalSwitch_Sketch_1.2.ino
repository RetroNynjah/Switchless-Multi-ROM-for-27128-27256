...
#########################################################################################
#                                                                                       #
#  Kernal switcher sketch for C128DCR (28-pin ROM)                                      #
#  To be used with the Retroninja 27128/27256 switchless multi-ROM in 27256 mode.       #
#                                                                                       #
#  Version 1.2                                                                          #
...
// Searchstring below is RNROM128#
// The command will be followed by a single byte ROM number between 1 (0x01) and 15 (0x0f)
byte searchString[] = {0x52,0x4E,0x52,0x4F,0x4D,0x31,0x32,0x38,0x44,0x43,0x52,0x23}; // "RNROM128DCR#"
...
void setup() {
  ...
  // release reset
  pinMode(resetPin, INPUT);
  delay(1000); // Give system some time to reset before entering loop
